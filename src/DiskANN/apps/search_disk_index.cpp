...
#pragma omp parallel for schedule(dynamic, 1)
    ...
    diskann::cout << std::setw(6) << "L" << std::setw(12) << "Beamwidth" << std::setw(16) << "QPS" << std::setw(16)
                  ...
                  << std::setw(16) << "Node Reqs" << std::setw(16) << "Unique Sec" << std::setw(12) << "Dedup%";
    if (calc_recall_flag)
    {
...
#pragma omp parallel for schedule(dynamic, 1)
        ...
        auto mean_node_reqs = diskann::get_mean_stats<uint32_t>(
            stats, query_num,
            [](const diskann::QueryStats &stats) { return stats.n_node_io_requests; });
        auto mean_unique_secs = diskann::get_mean_stats<uint32_t>(
            stats, query_num,
            [](const diskann::QueryStats &stats) { return stats.n_unique_sectors; });
        double mean_dedup_pct = (mean_node_reqs > 0)
                                    ? 100.0 * (1.0 - (double)mean_unique_secs / (double)mean_node_reqs)
                                    : 0.0;
        ...
        diskann::cout << std::setw(6) << L << std::setw(12) << optimized_beamwidth << std::setw(16) << qps
                      ...
                      << std::setw(16) << mean_node_reqs << std::setw(16) << mean_unique_secs
                      << std::setw(12) << (int)mean_dedup_pct;
        if (calc_recall_flag)
        {
